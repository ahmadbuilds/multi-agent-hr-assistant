...
def make_librarian_retrieval_tool(retrieval_port:LibrarianRetrievalPort):
    @tool(name="librarian_retrieval_tool", description="Tool for the Librarian Agent to retrieve relevant document based on the user query.")
...
def make_librarian_update_tool(update_port:LibrarianUpdatePort):
    @tool(name="librarian_update_tool", description="Tool for the Librarian Agent to update an existing document based on the provided content.")
...
def make_librarian_insertion_tool(insertion_port:LibrarianInsertionPort):
    @tool(name="librarian_insertion_tool", description="Tool for the Librarian Agent to insert a new document based on the provided content.")
